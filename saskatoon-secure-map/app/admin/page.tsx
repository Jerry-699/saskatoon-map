  ...
  return (
    <main className="shell" style={{ width: 'min(94vw, 820px)' }}>
      <div className="card">
        ...
        <div className="message" style={{ marginTop: 18, marginBottom: 18 }}>
          <strong>Publish hydrant changes to all users</strong>
          <p className="muted" style={{ marginBottom: 10 }}>
            After you finish adding or deleting manual hydrants, press this once.
            Each device will keep its saved City hydrants and download the combined hydrant list only once when it sees the new version.
          </p>
          <form action={publishHydrantUpdate}>
            <button type="submit">↻ Publish Hydrant Update</button>
          </form>
        </div>
