    ...
    <main className="shell" style={{ width: 'min(94vw, 820px)' }}>
      <div className="card">
        ...
        <div className="message" style={{ marginBottom: 18 }}>
          <strong>Publish map changes to all users</strong>
          <p className="muted" style={{ marginBottom: 10 }}>
            Make all your route and manual-hydrant changes first, then press this once. Users will keep cached data until you publish.
          </p>
          <form action={publishMapUpdates}>
            <button type="submit">🚀 Publish Updates</button>
          </form>
        </div>
